    ...
    <div class="main-container">
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="card-box mb-30">
                    <div class="pd-20">
                        <h4 class="text-blue h4">Data Cancel Sample Request</h4>
                    </div>
                    <div class="pb-20">
                            ...
                            <tbody>
                                <?php while ($row = mysqli_fetch_object($queryInventory)) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/pages/staff/sample-request-detail.php?cc=<?= $row->no_sample ?>" class="text-decoration-none"><?= $row->no_sample ?></a>
                                        </td>
                                        <td><?= $row->subject ?></td>
                                        ...
                                        <td>
                                            <?php if ($row->status == 6) : ?>
                                                <p class="fomt-weight-bold text-danger">Cancel</p>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
