                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    ...
                                                    <?php if ($_SESSION['user']['role'] == 'Staff' && $_SESSION['user']['dept'] == 'MK') : ?>
                                                        <?php if ($row->status == 6) : ?>
                                                            <p class="dropdown-item text-danger"><i class="bi bi-x-circle"></i>Cancelled</p>
                                                        <?php else : ?>
                                                            <a class="dropdown-item text-danger" href="sample-request-canceling.php?cc=<?= $row->no_sample ?>&status=6"><i class="bi bi-x-circle"></i>Cancel</a>
                                                        <?php endif; ?>
